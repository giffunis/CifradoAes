...
public class FirmaDigital {
	...
	public String firmar(String cadena) throws UnsupportedEncodingException, SignatureException {
		...
		// String encoded = Base64.getEncoder().encodeToString(strByte);
		...
		// return "Signature: " + new BigInteger(1, realSig).toString(16);
		return sign;
	}
	...
	public String getPrivateKeyBase64() {	
		...
		String clave2 = Base64.getEncoder().encodeToString(prueba2);
	...
	public void imprimirBase64() {
		...
		String clave = Base64.getEncoder().encodeToString(prueba);
